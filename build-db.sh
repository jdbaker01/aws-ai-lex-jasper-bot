...
#
# aws glue delete-database --name $ATHENA_DB_NAME
...
#
a --recursive --source-region $SOURCE_DATA_REGION --region $ATHENA_BUCKET_REGIONws s3 cp $SOURCE_DATA/event/allevents_pipe.txt $ATHENA_BUCKET/event/allevents_pipe.txt
